...
`make` is not available on Windows. Use the included PowerShell scripts instead.
...
### Daily commands (replaces `make`)

```powershell
.\make.ps1 up              # Start containers
.\make.ps1 down            # Stop containers
.\make.ps1 logs            # Tail logs
.\make.ps1 ps              # List containers

.\make.ps1 migrate-app1    # Run migrations for app1
.\make.ps1 fresh-app1      # Fresh migrate + seed app1
.\make.ps1 shell-app1      # Open shell in backend-app1
.\make.ps1 tinker-app1     # Laravel Tinker for app1
